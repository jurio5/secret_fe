                  ...
                  <tbody className="bg-gray-800/30 divide-y divide-gray-700">
                    {rankings.map((ranking, index) => (
                      <tr 
                        key={ranking.id}
                        className={`${
                          currentUser?.id === ranking.id ? 'bg-blue-900/30' : 
                      ...
                      >
                        ...
                        <td className="px-3 py-3 whitespace-nowrap">
                          <div className="flex items-center">
                            ...
                            <div className="ml-3">
                              <div className={`font-medium ${currentUser?.id === ranking.id ? 'text-blue-400' : 'text-white'}`}>
                                {ranking.nickname}
                                {currentUser?.id === ranking.id && <span className="ml-2 text-xs text-blue-400">(나)</span>}
                              </div>
                            </div>
                          </div>
                        </td>
